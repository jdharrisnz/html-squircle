...
export type GetAttributes<T extends Types.TagName> = T extends keyof HTMLElementTagNameMap ? HTMLAttributes<Types.TagNameMap[T]> : T extends keyof SVGElementTagNameMap ? SVGAttributes<Types.TagNameMap[T]> : never;
export declare namespace Types {
    type TagName = keyof HTMLElementTagNameMap | keyof SVGElementTagNameMap;
    interface TagNameMap extends HTMLElementTagNameMap, Omit<SVGElementTagNameMap, "a" | "style" | "script" | "title"> {
    }
