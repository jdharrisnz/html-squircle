(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global["bg-squircle"] = {}));
  ...
  const newSquirclers = ({
    ...
    ({
      ...
      const gradient = isGradient ? (
        // eslint-disable-next-line no-restricted-properties
        `<linearGradient id='${gradientId}' gradientTransform='rotate(${svgBackground.gradientAngle ?? 0})'>${svgBackground.stops.map(
