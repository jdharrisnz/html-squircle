(function (factory) {
    ...
    exports.backgroundSquircle = exports.clipSquircle = exports.tag = void 0;
    /** @internal */
    ...
    const clipSquircle = ({ width, height, curveLength, roundness = 0.2 }) => `path('${getPath(width, height, ...getCurveSpec(width, height, curveLength, roundness))}')`;
    ...
    const backgroundSquircle = ({ width, height, curveLength, roundness = 0.2, stroke = "none", strokeWidth = 1, background = "#fff", injectedDefs = "", injectedBody = "" }) => {
        ...
        const svg = encodeURIComponent((0, exports.tag)("svg", {
            xmlns: "http://www.w3.org/2000/svg",
            width: `${width}px`,
            height: `${height}px`
        }, (0, exports.tag)("defs", {}, (0, exports.tag)("path", { id: pathId, d }), (0, exports.tag)("rect", { id: rectId, width: "100%", height: "100%" }), (0, exports.tag)("clipPath", { id: clipId }, (0, exports.tag)("use", { href: `#${pathId}` })), (0, exports.tag)("mask", { id: maskId }, (0, exports.tag)("use", { href: `#${rectId}`, fill: "black" }), (0, exports.tag)("use", {
            href: `#${pathId}`,
            stroke: "#fff",
            "stroke-width": `${strokeWidth * 2}px`
        })), isGradient
            ? (0, exports.tag)("linearGradient", {
                id: gradientId,
                gradientTransform: `rotate(${background.gradientAngle ?? 0} 0.5 0.5)`
            }, ...background.stops.map(({ offset, stopColor }) => (0, exports.tag)("stop", {
                offset,
                "stop-color": stopColor
            })))
            : "", typeof injectedDefs === "function"
            ? injectedDefs(injectorArg)
            : injectedDefs), (0, exports.tag)("use", {
            href: `#${pathId}`,
